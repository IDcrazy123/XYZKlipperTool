...
- Cổng kế tiếp: supervisor review Phase 03; hành vi vật lý vẫn `REQUIRES_HIL`
...
| 03 Camera và pipeline thị giác | `IMPLEMENTED` | Candidate offline; chưa có corpus thật sanitize, gate holdout/reliability `NEEDS_WORK`; hành vi vật lý `REQUIRES_HIL` |
