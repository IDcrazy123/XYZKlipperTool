...
| 03 Camera và pipeline thị giác | `NEEDS_WORK` | Đã triển khai adapter JPEG bounded phía host và test hai candidate độc lập; ảnh user thật vẫn chưa gán nhãn/bị loại, reliability synthetic chưa được chứng minh, HIL một phần có 1 T0 invalid + 3 frame T1 LED-on bị loại và 0 frame T2; hành vi vật lý `REQUIRES_HIL` |
