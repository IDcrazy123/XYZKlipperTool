...
| 03 Camera và pipeline thị giác | `NEEDS_WORK` | HOLDOUT synthetic Blob/Circle đều TP=0, FN=1, TN=1, precision=0.0, recall=0.0; HIL một phần có 1 T0 invalid + 3 frame T1 LED-on bị loại và 0 frame T2; đánh giá corpus thật sanitize còn `NEEDS_WORK`; hành vi vật lý `REQUIRES_HIL` |
