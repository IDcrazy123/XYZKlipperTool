...
| REQ-STATE-001 | Master prompt; ASSUMPTION | requirements; persistence schema design | planned: ID/state round-trip tests |
| REQ-TOOL-001 | EVID-XY-001; Master prompt | adapter contract; measurement protocol | planned: dynamic discovery tests |
| REQ-PROVIDER-001 | EVID-Z-001; SRC-008 | provider ADR/contracts | planned: switch/Cartographer fixtures |
...
| REQ-STAT-001 | EVID-XY-001; Master prompt | statistics requirements | planned: n=0/n=1 and summary tests |
| REQ-OUTLIER-001 | EVID-XY-001 | estimator/outlier policy | planned: retained T3 outlier fixture |
...
| REQ-SCHEMA-001 | Master prompt; ASSUMPTION | schema/version plan | planned: migration/round-trip tests |
...
| REQ-APPLY-001 | EVID-Z-001; Master prompt | apply transaction ADR boundary | planned: preview/backup/rollback fault tests |
| REQ-FRESH-001 | Master prompt; ASSUMPTION | freshness validation design | planned: stale/mismatch rejection tests |
...
| REQ-PORT-001 | SRC-002; Master prompt | architecture context; ports list | planned: domain import and fake adapter tests |
