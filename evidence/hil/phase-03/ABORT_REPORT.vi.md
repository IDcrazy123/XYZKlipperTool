...
Truy vấn LED-off T2 ban đầu cho thấy mọi kênh `color_data` của T0–T4 đều đúng bằng zero, nhưng `toolchanger.tool_number=-1` mâu thuẫn với `detected_tool_number=2`; vì vậy capture bị từ chối fail-closed. Truy vấn supervisor sau đó ngày 2026-09-05 ghi nhận máy đứng yên tại X170 Y20 Z40 hiển thị, T0 declared/detected và heater target bằng 0, nhưng `homed_axes` rỗng. Báo cáo này không cho phép lệnh home, chuyển động, camera, LED hoặc Moonraker nào.
